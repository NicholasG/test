...
public class PictureDAO implements DAO<Picture> {
    ...
    private static final String SELECT_ALL_QUERY = "SELECT * FROM pictures";
    ...
    private static final String SELECT_ONE_BY_ID_QUERY = "SELECT * FROM pictures " +
            "WHERE id = ?";
    ...
    public List<Picture> findAll() {
        LOG.info( "Finding all of pictures" );
